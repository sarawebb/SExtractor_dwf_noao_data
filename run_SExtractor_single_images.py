...
Arguments:
	...
	image_type (string)
		The image type, either single or stacked.
	thresh (string)
...
def run_SExtractor_single_images(year, month, field, color_type, image_type, thresh, mag_zpt, verbose=False,debugmode=False):
	if image_type == 'single':
		...
		path = '/fred/oz100/NOAO_archive/archive_NOAO_data/data_outputs/'+year+'/'+month+'/'+field+'/'+color_type+'/'+image_type+'/*_ext_*'
	print(path)
...
if __name__ == "__main__":
	...
	if debugmode: 
		print(arguments)
	run_SExtractor_single_images(year, month, field, color_type, image_type, thresh, mag_zpt, verbose=False, debugmode=False)
